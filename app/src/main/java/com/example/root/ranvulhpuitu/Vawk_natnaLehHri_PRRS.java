...
public class Vawk_natnaLehHri_PRRS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vawk_natna_leh_hri__prrs);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.natna2);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: fragment = new Vawk_natnaLehHri_PRRS_landan();break;
                case 1: fragment = new Vawk_natnaLehHri_PRRS_enkawldan();break;
            }
            return fragment;
        }
