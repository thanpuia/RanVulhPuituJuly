...
public class Ar_InfectiousCoryza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ar__infectious_coryza);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(R.string.infectious_coryza);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                WhatsApp send = new WhatsApp(Ar_InfectiousCoryza.this);
                send.whatsappSend();
            }
        });
    ...
    public void ic1Click(View view) {
        // Log.i("tag" ,"1111  ");
        Intent intent = new Intent(this,img_ic.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: fragment = new Ar_InfectiousCoryza_Landan();break;
                case 1: fragment = new Ar_InfectiousCoryza_Enkawldan();break;
            }
            return fragment;
        }
